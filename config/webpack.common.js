  ...
  return {
    ...
    plugins: [
      ...
      */
       ...
       * The location (key) is then exported to the trello-item under then htmlElements property in webpack configuration.
       *
       * Example:
       ...
       *  })
       *
       *  Means we can use it in the trello-item like this:
